...
def register_viewer(full_name: str, email: str, password: str) -> tuple[bool, str]:
    """
    Public self-registration — role is locked to ROLE_VIEWER.
    No admin privileges required. Returns (success, message).
    """
    from .roles import ROLE_VIEWER
    return create_user(full_name, email, password, ROLE_VIEWER)
